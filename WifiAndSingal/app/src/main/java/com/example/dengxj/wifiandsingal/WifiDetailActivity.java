...
public class WifiDetailActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (savedInstanceState == null) {
            ...
            arguments.putString(WifiDetailFragment.ARG_ITEM_ID,
                    getIntent().getStringExtra(WifiDetailFragment.ARG_ITEM_ID));
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == android.R.id.home) {
            ...
            //
            navigateUpTo(new Intent(this, WifiListActivity.class));
            return true;
        }
